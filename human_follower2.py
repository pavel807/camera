...
exp.setup(6, GPIO.OUT)# set GPIO 20 as output pin
exp.setup(7, GPIO.OUT)# set GPIO 21 as output pin
      
pin20 = GPIO.PWM(24, 100)    # create object pin20 for PWM on port 20 at 100 Hertz  
pin21 = GPIO.PWM(25, 100)    # create object pin21 for PWM on port 21 at 100 Hertz  
